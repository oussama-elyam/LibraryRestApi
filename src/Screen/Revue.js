...
const Revue = () => {
    ...
    const GetRevueData = () => {
        ...
        const url = 'http://localhost:8080/revue/listeRevue'
         axios.get(url)
            .then(response => {
    ...
    const handleSubmite = () => {
        const url = 'http://localhost:8080/revue/addRevue'
        const Credentials = { titre, prix, nbrExpl, auteur, disponible}
    ...
    return (
        ...
        />
             ...
             <div className='model-box-view'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Carte Revue</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
            ...
            <div className='model-box-view'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Modifier un Revue</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            <div className='form-group'>
