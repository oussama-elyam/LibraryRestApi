...
const Livre = () => {
    ...
    const GetLivreData = () => {
        ...
        const url = 'http://localhost:8080/livre/listeLivre'
         axios.get(url)
            .then(response => {
    ...
    const handleSubmite = () => {
        const url = 'http://localhost:8080/livre/addLivre'
        const Credentials = { titre, prix, nbrExpl, auteur, disponible, pages }
             ...
             <div className='model-box-view'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Carte Livre</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' value={RowData.pages} readOnly />
                            </div>
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' onChange={(e) => setpages(e.target.value)} placeholder="pages" />
                            </div>
